...
const TEMPLATES = {
  ...
  logical_pairs_questions: {
    name: 'Логічні пари',
    headers: ['Тема', 'Інструкція', 'Ліва 1', 'Ліва 2', 'Ліва 3', 'Ліва 4', 'Права А', 'Права Б', 'Права В', 'Права Г', 'Пара 1→(А/Б/В/Г)', 'Пара 2→(А/Б/В/Г)', 'Пара 3→(А/Б/В/Г)', 'Пара 4→(А/Б/В/Г)', 'Пояснення', 'URL зображення'],
